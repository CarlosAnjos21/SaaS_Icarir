...
// Base da API para corrigir URLs relativas vindas do backend
const API_BASE_URL = import.meta.env.VITE_API_URL || "";
 
/**
 * Sanitiza a URL da imagem antes de passar ao componente.
 * - Descarta valores inválidos (undefined, null, string "undefined"/"null", vazio)
 * - Corrige URLs relativas adicionando a base da API
 */
    ...
    <div className="min-h-screen bg-gray-50 text-gray-800 font-sans relative">
      ...
      <section className="relative bg-gradient-to-b from-[#002B5B] to-gray-50 dark:from-[#001a40] dark:to-[#3a3a3a] pt-20 pb-8 overflow-hidden min-h-[200px]">
        ...
        <div
          ...
          style={{
            backgroundImage: `url(${logoIcarir})`,
      ...
      <section className="relative max-w-[1800px] mx-auto py-16 px-6 z-20">
        <div className="bg-white/90 dark:bg-[#2f2f2f] backdrop-blur-md rounded-2xl p-8 shadow-xl dark:shadow-2xl mb-12 relative z-10 max-w-4xl mx-auto text-center border border-gray-100 dark:border-gray-700">
          <span className="text-[#FE5900] dark:text-[#394C97] font-bold uppercase tracking-widest text-sm">
            Expandir Horizontes
          </span>
          <h2 className="text-3xl md:text-5xl font-bold text-[#394C97] dark:text-[#FE5900] mt-2">
            Destinos para Empreendedores
          </h2>
          <p className="text-gray-600 dark:text-gray-300 mt-4 max-w-2xl mx-auto">
            Descubra ecossistemas de inovação, feche negócios e participe de missões exclusivas nas
            cidades mais dinâmicas do nosso país.
          </p>
            ...
            {missions.length > 0 ? (
              missions.map((mission) => (
                <HomeCard
                  ...
                  image={sanitizeImageUrl(mission.foto_url || mission.imageUrl)}
                  title={mission.titulo}
                  onStartMission={() => handleViewMission(mission)}
                  animation="fade-up"
                />
              ))
            ) : (
